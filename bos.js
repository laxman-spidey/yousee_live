...
BarsOfStuff.STYLES = [
  ...
  {name:'book', img: 'book.jpg', height: 30},
  {name:'time', img: 'time.jpg', height: 30},
  {name:'volunteer', img: 'volunteer.jpg', height: 38}
];

BarsOfStuff.IMGPATH = BarsOfStuff.protocol + '//yousee.in/images/';
