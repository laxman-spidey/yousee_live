...
echo "<p> Generate Certificate for:</p>";
echo "<select name=\"certificate\">";
...
echo "<tr><td>3</td><td>Donation for Project (A)</td><td>INR. ".$project_donation."</td><tr>";
echo "<tr><td>4</td><td>Donation for UC (B)</td><td>INR. ".$uc_donation."</td><tr>";
echo "<tr><td>5</td><td><b>Donation for UC</b> (C)=(A)+(B)</td><td><b>INR. ".$total_donation."</b></td><tr>";
echo "<tr><td>6</td><td><b>Date of Donation</b></td><td><b>".$date."</b></td><tr>";
echo "<tr><td>7</td><td><b>Mode of Payment<b></td><td><b>".$paymentmode." ".$chequenumber."</b></td><tr>";
?>
